...
import 'package:projects/models/city.dart';
import 'package:projects/models/constants.dart';
import 'package:projects/ui/home.dart';
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      if (cities[index].isSelected) {
                        // Eğer şehir zaten eklenmemişse ekle
                        if (!selectedCities.any((city) => city.city == cities[index].city)) {
                          selectedCities.add(cities[index]);
                        }
                      } else {
                        // Şehri listeden kaldır
                        selectedCities.removeWhere((city) => city.city == cities[index].city);
                      }
                    });
                  },
                  child: Image.asset(
                    cities[index].isSelected == true ? 'assets/checked-.png' : 'assets/uncheck.png',
                    width: 30,
                  ),
                ),
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) => Home(
                selectedCities: selectedCities.map((city) => city.city).toList(),
              ),
            ),
          );
        },
